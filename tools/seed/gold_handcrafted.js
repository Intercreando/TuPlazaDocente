...
const handcrafted = [
  ...
  gold({
    ...
    cargo: "primaria",
    caso: "Una docente de 5° cierra el periodo con el promedio de cuatro quizzes cronometrados. No hubo rúbricas previas ni devolución durante las semanas. El consejo de padres pide 'más rigor' y un colega sugiere no cambiar nada 'para que sea igual para todos'. El SIEE institucional habla de evaluación formativa.",
    stem: "¿Qué decisión articula el Decreto 1290 con una evaluación al servicio del aprendizaje, sin caer en “rigor” vacío ni en flexibilidad sin evidencia?",
    options: [
    ...
    correct: "B",
    norma: "El Decreto 1290 concibe la evaluación como integral, flexible y formativa, al servicio del aprendizaje y la promoción, con criterios conocidos y evidencias de proceso.",
    theory: "La retroalimentación con criterios convierte la evidencia en mejora; el promedio aislado certifica, no forma.",
    wrong: {
      A: "El ranking y la rúbrica tardía simulan rigor, pero niegan autorregulación y carácter formativo.",
      C: "La flexibilidad sin evidencia vuelve arbitraria la valoración y no cumple el SIEE.",
      D: "Repetir el mismo instrumento no es recuperación: no hay nueva enseñanza ni otra forma de demostrar el aprendizaje.",
    },
