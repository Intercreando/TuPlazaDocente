# -*- coding: utf-8 -*-
"""Parche de questions_v1.json (1081-1130) según reglas_cnsc.md."""
import json
import subprocess
import sys
...
CHUNKS = [(1081, 1090), (1091, 1100), (1101, 1110), (1111, 1120), (1121, 1130)]
PATCH_KEYS = [
    "options",
    "explanation",
...
def main():
    r = subprocess.run(
        [sys.executable, str(ROOT / "_tmp_validate_lote_1081_1130.py")],
        cwd=ROOT,
    )
    if r.returncode != 0:
