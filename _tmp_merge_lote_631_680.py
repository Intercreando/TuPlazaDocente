# -*- coding: utf-8 -*-
"""Parche de questions_v1.json (631-680) según reglas_cnsc.md."""
import json
import subprocess
import sys
...
def main():
    r = subprocess.run(
        [sys.executable, str(ROOT / "_tmp_validate_lote_631_680.py")],
        cwd=ROOT,
    )
    if r.returncode != 0:
