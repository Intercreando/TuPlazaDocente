  ...
  static const List<LegalSection> terms = [
    ...
    LegalSection(
      ...
      body:
          ...
          'Cada persona aprende distinto; la app construye un perfil propio (racha, progreso, plan y '
          'temas). Si varias personas usan la misma cuenta, ese perfil se contamina y el '
