# -*- coding: utf-8 -*-
"""Parche de questions_v1.json (681-730) según reglas_cnsc.md."""
import json
import subprocess
import sys
...
CHUNKS = [(681, 690), (691, 700), (701, 710), (711, 720), (721, 730)]
PATCH_KEYS = [
    "options",
    "explanation",
...
def main():
    r = subprocess.run(
        [sys.executable, str(ROOT / "_tmp_validate_lote_681_730.py")],
        cwd=ROOT,
    )
    if r.returncode != 0:
