# -*- coding: utf-8 -*-
"""Parche de questions_v1.json (781-830) según reglas_cnsc.md."""
import json
import subprocess
import sys
...
CHUNKS = [(781, 790), (791, 800), (801, 810), (811, 820), (821, 830)]
PATCH_KEYS = [
    "options",
    "explanation",
...
def main():
    r = subprocess.run(
        [sys.executable, str(ROOT / "_tmp_validate_lote_781_830.py")],
        cwd=ROOT,
    )
    if r.returncode != 0:
