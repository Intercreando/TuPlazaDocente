...
const outs = [
  "_tmp_out_331_340.json",
  "_tmp_out_341_350.json",
  "_tmp_out_351_360.json",
  "_tmp_out_361_370.json",
  "_tmp_out_371_380.json",
...
const slice = items.slice(330, 380);
const ids = [];
const mismatches = [];
...
fs.writeFileSync("_tmp_qc_sample_331_380.json", JSON.stringify(sample, null, 2) + "\n", "utf8");
