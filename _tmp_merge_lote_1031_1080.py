# -*- coding: utf-8 -*-
"""Parche de questions_v1.json (1031-1080) según reglas_cnsc.md."""
import json
import subprocess
import sys
...
def main():
    r = subprocess.run(
        [sys.executable, str(ROOT / "_tmp_validate_lote_1031_1080.py")],
        cwd=ROOT,
    )
    if r.returncode != 0:
