# -*- coding: utf-8 -*-
"""Parche de questions_v1.json (931-980) según reglas_cnsc.md."""
import json
import subprocess
import sys
...
CHUNKS = [(931, 940), (941, 950), (951, 960), (961, 970), (971, 980)]
PATCH_KEYS = [
    "options",
    "explanation",
...
def main():
    r = subprocess.run(
        [sys.executable, str(ROOT / "_tmp_validate_lote_931_980.py")],
        cwd=ROOT,
    )
    if r.returncode != 0:
